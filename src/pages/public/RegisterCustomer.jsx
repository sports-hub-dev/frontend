...
const RegisterCustomer = () => {
  ...
  return (
    <AuthCard title="Create your account" subtitle="Shop uniforms &amp; PPE across Egypt, instantly active">
      ...
      <p className="mt-6 text-center text-sm text-navy-500">
        Already have an account?{" "}
        <Link to={ROUTES.LOGIN} className="font-semibold text-navy-900 hover:underline">Log in</Link>
      </p>
      <p className="mt-2 text-center text-sm text-navy-500">
        Registering on behalf of a DSP company?{" "}
        <Link to={ROUTES.REGISTER_VENDOR} className="font-semibold text-navy-900 hover:underline">Register as a vendor user</Link>
      </p>
    </AuthCard>
  );
};
